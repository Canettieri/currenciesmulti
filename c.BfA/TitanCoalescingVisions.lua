...
local ICON = "Interface\\Icons\\inv_enchanting_wod_essence2"
...
local function GetButtonText(self, id)
	...
	return L["CoaviLabel"], currencyCountText .. BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["CoaviDescription"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mBfA"] .. " Titan|cFF66b1ea " .. L["CoaviTitle"] .. "|r",
	tooltip = L["CoaviTitle"],
	icon = ICON,
