...
local ICON = "Interface\\Icons\\inv_inscription_80_vantusrune_nyalotha"
...
local function GetButtonText(self, id)
	...
	return L["ENyalothaLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["ENyalothDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mBfA"].." Titan|cFF66b1ea "..L["ENyalothTitle"].."|r",
	tooltip = L["ENyalothTitle"],
	icon = ICON,
