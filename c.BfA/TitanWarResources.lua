...
local ICON = "Interface\\Icons\\inv__faction_warresources"
...
local function GetButtonText(self, id)
	...
	return L["WResLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["WResDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mBfA"].." Titan|cFF66b1ea "..L["WResTitle"].."|r",
	tooltip = L["WResTitle"],
	icon = ICON,
