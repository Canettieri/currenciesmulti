...
local function GetButtonText(self, id)
	...
	return L["PoliLabel"], currencyCountText .. barBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	local valorBag = L["totalbag"].. "\t" ..TitanUtils_GetHighlightText(GetItemCount(163036)).."\n"
	local valorBank = L["totalbank"].. "\t" ..TitanUtils_GetHighlightText(GetItemCount(163036, true) - GetItemCount(163036))
...
L.Elib({
	id = ID,
	name = L["mBfA"].." Titan|cFF66b1ea "..L["PoliTitle"].."|r",
	tooltip = L["PoliTitle"],
