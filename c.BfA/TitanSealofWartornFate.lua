...
local ICON = "Interface\\Icons\\timelesscoin_yellow"
...
local function GetTooltipText(self, id)
	...
	return L["WartornDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mBfA"].." Titan|cFF66b1ea "..L["WartornTitle"].."|r",
	tooltip = L["WartornTitle"],
	icon = ICON,
