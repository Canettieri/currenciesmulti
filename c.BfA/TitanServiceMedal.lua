...
if UnitFactionGroup("Player") == "Alliance" then
	...
	ICON = "Interface\\Icons\\inv_hordewareffort"
end
local TITLE
if UnitFactionGroup("Player") == "Alliance" then
	TITLE = L["SMedalATitle"]
else
	TITLE = L["SMedalHTitle"]
end
local CURRENCY_ID
if UnitFactionGroup("Player") == "Alliance" then
	CURRENCY_ID = 1717
...
local function GetTooltipText(self, id)
	...
	return L["SMedalDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mBfA"].." Titan|cFF66b1ea "..TITLE.."|r",
	tooltip = TITLE,
	icon = ICON,
