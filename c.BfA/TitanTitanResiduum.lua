...
local ICON = "Interface\\Icons\\inv_azeritedebuff"
...
local function GetButtonText(self, id)
	...
	return L["TitanTitanLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["TitanTitanDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mBfA"].." Titan|cFF66b1ea "..L["TitanTitanTitle"].."|r",
	tooltip = L["TitanTitanTitle"],
	icon = ICON,
