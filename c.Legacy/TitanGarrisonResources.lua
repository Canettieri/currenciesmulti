--[[
Description: This plugin is part of the "Titan Panel [Currencies] Multi" addon. It shows your amount of Garrison Resources.
...
local function GetButtonText(self, id)
	...
	return L["ResourcesLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["ResourcesDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWoD"].." Titan|cFF66b1ea "..L["ResourcesTitle"].."|r",
	tooltip = L["ResourcesTitle"],
	icon = ICON,
