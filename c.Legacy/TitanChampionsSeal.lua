...
local ICON = "Interface\\Icons\\ability_paladin_artofwar"
...
local function GetTooltipText(self, id)
	...
	return L["ChampionsDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["ChampionsTitle"].."|r",
	tooltip = L["ChampionsTitle"],
	icon = ICON,
