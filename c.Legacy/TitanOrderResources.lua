...
local ICON = "Interface\\Icons\\inv_orderhall_orderresources"
...
local function GetButtonText(self, id)
	...
	return L["OrderLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["OrderDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mLegion"].." Titan|cFF66b1ea "..L["OrderTitle"].."|r",
	tooltip = L["OrderTitle"],
	icon = ICON,
