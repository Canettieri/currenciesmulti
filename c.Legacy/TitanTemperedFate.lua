...
local ICON = "Interface\\Icons\\ability_animusorbs"
...
local function GetButtonText(self, id)
	...
	return L["TemperedLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["TemperedDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWoD"].." Titan|cFF66b1ea "..L["TemperedTitle"].."|r",
	tooltip = L["TemperedTitle"],
	icon = ICON,
