...
local ID = "AC"
local ICON = "Interface\\Icons\\Inv_Apexis_Draenor"
...
local function GetButtonText(self, id)
	...
	return L["ApexisLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["ApexisDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWoD"].." Titan|cFF66b1ea "..L["ApexisTitle"].."|r",
	tooltip = L["ApexisTitle"],
	icon = ICON,
