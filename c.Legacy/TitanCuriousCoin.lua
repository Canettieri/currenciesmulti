...
local ICON = "Interface\\Icons\\inv_misc_curiouscoin"
...
local function GetTooltipText(self, id)
	...
	return L["CuriousDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mLegion"].." Titan|cFF66b1ea "..L["CuriousTitle"].."|r",
	tooltip = L["CuriousTitle"],
	icon = ICON,
