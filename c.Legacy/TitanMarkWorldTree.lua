...
local ICON = "Interface\\Icons\\inv_misc_markoftheworldtree"
...
local function GetButtonText(self, id)
	...
	return L["WorldTreeLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["WorldTreeDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mCata"].." Titan|cFF66b1ea "..L["WorldTreeTitle"].."|r",
	tooltip = L["WorldTreeTitle"],
	icon = ICON,
