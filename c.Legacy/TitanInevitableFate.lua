...
local ICON = "Interface\\Icons\\achievement_battleground_templeofkotmogu_02_green"
...
local function GetTooltipText(self, id)
	...
	return L["InevitableDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWoD"].." Titan|cFF66b1ea "..L["InevitableTitle"].."|r",
	tooltip = L["InevitableTitle"],
	icon = ICON,
