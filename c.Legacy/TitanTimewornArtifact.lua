...
local ICON = "Interface\\Icons\\inv_ashran_artifact"
...
local function GetButtonText(self, id)
	...
	return L["TimewornLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["TimewornDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mLegion"].." Titan|cFF66b1ea "..L["TimewornTitle"].."|r",
	tooltip = L["TimewornTitle"],
	icon = ICON,
