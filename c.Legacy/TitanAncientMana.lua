...
local ICON = "Interface\\Icons\\inv_misc_ancient_mana"
...
local function GetButtonText(self, id)
	...
	return L["ManaLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["ManaDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mLegion"].." Titan|cFF66b1ea "..L["ManaTitle"].."|r",
	tooltip = L["ManaTitle"],
	icon = ICON,
