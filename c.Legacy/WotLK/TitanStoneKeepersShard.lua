...
local ICON = "Interface\\Icons\\inv_misc_platnumdisks"
...
local function GetTooltipText(self, id)
	...
	return L["LKCurrency05Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["LKCurrency05Title"].."|r",
	tooltip = L["LKCurrency05Title"],
	icon = ICON,
