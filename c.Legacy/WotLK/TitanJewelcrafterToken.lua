...
local ICON = "Interface\\Icons\\inv_misc_gem_variety_01"
...
local function GetTooltipText(self, id)
	...
	return L["LKCurrency04Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["LKCurrency04Title"].."|r",
	tooltip = L["LKCurrency04Title"],
	icon = ICON,
