--[[
Description: This plugin is part of the "Titan Panel [Currencies] Multi" addon. It shows your amount of Emblem of Heroism.
...
local ID = "TITAN_EMHMM"
local ICON = "Interface\\Icons\\spell_holy_proclaimchampion"
local CURRENCY_ID = 101
...
local function GetButtonText(self, id)
	...
	return L["ChampionsLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["LKCurrency02Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["LKCurrency02Title"].."|r",
	tooltip = L["LKCurrency02Title"],
	icon = ICON,
