...
local ICON = "Interface\\Icons\\pvp-arenapoints-icon"
...
local function GetButtonText(self, id)
	...
	return L["WartornLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["LKCurrency08Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["LKCurrency08Title"].."|r",
	tooltip = L["LKCurrency08Title"],
	icon = ICON,
