--[[
Description: This plugin is part of the "Titan Panel [Currencies] Multi" addon. It shows your amount of Venture Coin.
...
local ID = "TITAN_VTCNM"
local ICON = "Interface\\Icons\\inv_misc_coin_16"
local CURRENCY_ID = 201
...
local function GetTooltipText(self, id)
	...
	return L["LKCurrency06Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["LKCurrency06Title"].."|r",
	tooltip = L["LKCurrency06Title"],
	icon = ICON,
