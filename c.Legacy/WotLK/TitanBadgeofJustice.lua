--[[
Description: This plugin is part of the "Titan Panel [Currencies] Multi" addon. It shows your amount of Badge of Justice.
...
local ID = "TITAN_BDGJM"
local ICON = "Interface\\Icons\\spell_holy_championsbond"
local CURRENCY_ID = 42
...
local function GetTooltipText(self, id)
	...
	return L["LKCurrency01Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["LKCurrency01Title"].."|r",
	tooltip = L["LKCurrency01Title"],
	icon = ICON,
