...
local ICON = "Interface\\Icons\\spell_holy_proclaimchampion_02"
...
local function GetTooltipText(self, id)
	...
	return L["LKCurrency03Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["LKCurrency03Title"].."|r",
	tooltip = L["LKCurrency03Title"],
	icon = ICON,
