...
local ICON = "Interface\\Icons\\inv_misc_summonable_boss_token"
...
local function GetButtonText(self, id)
	...
	return L["LegionfallLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["LegionfallDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mLegion"].." Titan|cFF66b1ea "..L["LegionfallTitle"].."|r",
	tooltip = L["LegionfallTitle"],
	icon = ICON,
