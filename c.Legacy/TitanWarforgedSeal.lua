...
local ICON = "Interface\\Icons\\inv_arcane_orb"
...
local function GetButtonText(self, id)
	...
	return L["WarforgedLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["WarforgedDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mMoP"].." Titan|cFF66b1ea "..L["WarforgedTitle"].."|r",
	tooltip = L["WarforgedTitle"],
	icon = ICON,
