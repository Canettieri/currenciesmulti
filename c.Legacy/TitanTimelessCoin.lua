...
local ICON = "Interface\\Icons\\timelesscoin"
...
local function GetButtonText(self, id)
	...
	return L["TimelessLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["TimelessDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mMoP"].." Titan|cFF66b1ea "..L["TimelessTitle"].."|r",
	tooltip = L["TimelessTitle"],
	icon = ICON,
