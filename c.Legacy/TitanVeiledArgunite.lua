...
local ICON = "Interface\\Icons\\oshugun_crystalfragments"
...
local function GetButtonText(self, id)
	...
	return L["ArguniteLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["ArguniteDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mLegion"].." Titan|cFF66b1ea "..L["ArguniteTitle"].."|r",
	tooltip = L["ArguniteTitle"],
	icon = ICON,
