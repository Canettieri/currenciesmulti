...
local ICON = "Interface\\Icons\\inv_misc_coin_09"
...
local function GetButtonText(self, id)
	...
	return L["IronCoinsLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["IronCoinsDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWoD"].." Titan|cFF66b1ea "..L["IronCoinsTitle"].."|r",
	tooltip = L["IronCoinsTitle"],
	icon = ICON,
