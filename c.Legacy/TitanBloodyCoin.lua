...
local ICON = "Interface\\Icons\\timelesscoin-bloody"
...
local function GetButtonText(self, id)
	...
	return L["BloodyLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["BloodyDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mMoP"].." Titan|cFF66b1ea "..L["BloodyTitle"].."|r",
	tooltip = L["BloodyTitle"],
	icon = ICON,
