...
local ICON = "Interface\\Icons\\inv_misc_coin_17"
...
local function GetButtonText(self, id)
	...
	return L["GFortuneLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["GFortuneDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mMoP"].." Titan|cFF66b1ea "..L["GFortuneTitle"].."|r",
	tooltip = L["GFortuneTitle"],
	icon = ICON,
