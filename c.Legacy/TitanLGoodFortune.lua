...
local ICON = "Interface\\Icons\\inv_misc_coin_18"
...
local function GetButtonText(self, id)
	...
	return L["CuriousLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["LegacyC01Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mMoP"].." Titan|cFF66b1ea "..L["LegacyC01Title"].."|r",
	tooltip = L["LegacyC01Title"],
	icon = ICON,
