...
local ICON = "Interface\\Icons\\inv_datacrystal01"
...
local function GetButtonText(self, id)
	...
	return L["NetherLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["NetherDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mLegion"].." Titan|cFF66b1ea "..L["NetherTitle"].."|r",
	tooltip = L["NetherTitle"],
	icon = ICON,
