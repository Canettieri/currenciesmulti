...
local ICON = "Interface\\Icons\\inv_misc_ribbon_01"
...
local function GetButtonText(self, id)
	...
	return L["EpicureanLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["EpicureanDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mWotLK"].." Titan|cFF66b1ea "..L["EpicureanTitle"].."|r",
	tooltip = L["EpicureanTitle"],
	icon = ICON,
