...
local ICON = "Interface\\Icons\\inv_misc_azsharacoin"
...
local function GetButtonText(self, id)
	...
	return L["BrokenFateLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["BrokenFateDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mLegion"].." Titan|cFF66b1ea "..L["BrokenFateTitle"].."|r",
	tooltip = L["BrokenFateTitle"],
	icon = ICON,
