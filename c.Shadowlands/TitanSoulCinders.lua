...
local ICON = "Interface\\Icons\\inv_misc_supersoulash"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency16Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency16Title"] .. "|r",
	tooltip = L["SLCurrency16Title"],
	icon = ICON,
