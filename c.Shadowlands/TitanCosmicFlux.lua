...
local ICON = "Interface\\Icons\\inv_currency_cosmicflux"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency19Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency19Title"] .. "|r",
	tooltip = L["SLCurrency19Title"],
	icon = ICON,
