--[[
Description: This plugin is part of the "Titan Panel [Currencies] Multi" addon. It shows your amount of PvP Weekly Reward.
...
local ID = "TITAN_PVWRWM"
local ICON = "Interface\\Icons\\achievement_legionpvp2tier4"
local CURRENCY_ID = 1802
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency05Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency05Title"] .. "|r",
	tooltip = L["SLCurrency05Title"],
	icon = ICON,
