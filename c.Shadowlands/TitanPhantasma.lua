...
local ICON = "Interface\\Icons\\inv_phantasma"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency12Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency12Title"] .. "|r",
	tooltip = L["SLCurrency12Title"],
	icon = ICON,
