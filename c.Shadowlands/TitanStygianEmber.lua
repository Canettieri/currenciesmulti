...
local ICON = "Interface\\Icons\\ability_deathknight_soulreaper"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency17Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency17Title"] .. "|r",
	tooltip = L["SLCurrency17Title"],
	icon = ICON,
