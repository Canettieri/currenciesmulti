...
local ICON = "Interface\\Icons\\inv_stygia"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency08Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency08Title"] .. "|r",
	tooltip = L["SLCurrency08Title"],
	icon = ICON,
