...
local ICON = "Interface\\Icons\\inv_misc_paperbundle04a"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency15Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency15Title"] .. "|r",
	tooltip = L["SLCurrency15Title"],
	icon = ICON,
