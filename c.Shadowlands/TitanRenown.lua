...
local ICON = "Interface\\Icons\\inv_misc_covenant_renown"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency11Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency11Title"] .. "|r",
	tooltip = L["SLCurrency11Title"],
	icon = ICON,
