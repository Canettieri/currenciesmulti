...
local ICON = "Interface\\Icons\\achievement_dungeon_heroic_gloryoftheraider"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency13Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency13Title"] .. "|r",
	tooltip = L["SLCurrency13Title"],
	icon = ICON,
