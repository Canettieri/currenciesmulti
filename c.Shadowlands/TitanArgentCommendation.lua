--[[
Description: This plugin is part of the "Titan Panel [Currencies] Multi" addon. It shows your amount of Argent Commendation.
...
local ID = "TITAN_ARTCMM"
local ICON = "Interface\\Icons\\achievement_reputation_argentcrusader"
local CURRENCY_ID = 1754
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency01Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency01Title"] .. "|r",
	tooltip = L["SLCurrency01Title"],
	icon = ICON,
