--[[
Description: This plugin is part of the "Titan Panel [Currencies] Multi" addon. It shows your amount of Reservoir Anima.
...
local ID = "TITAN_RVRANM"
local ICON = "Interface\\Icons\\spell_animabastion_orb"
local CURRENCY_ID = 1813
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency10Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency10Title"] .. "|r",
	tooltip = L["SLCurrency10Title"],
	icon = ICON,
