...
local ICON = "Interface\\Icons\\inv_trinket_progenitorraid_02_blue"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency20Description"] .. "\r\r" .. ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency20Title"] .. "|r",
	tooltip = L["SLCurrency20Title"],
	icon = ICON,
