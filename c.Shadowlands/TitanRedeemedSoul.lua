...
local ICON = "Interface\\Icons\\sha_spell_warlock_demonsoul_nightborne"
...
local function GetTooltipText(self, id)
	...
	return L["SLCurrency09Description"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mShadowlands"] .. " Titan|cFF66b1ea " .. L["SLCurrency09Title"] .. "|r",
	tooltip = L["SLCurrency09Title"],
	icon = ICON,
