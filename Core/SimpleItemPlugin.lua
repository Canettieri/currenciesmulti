...
function L:CreateSimpleItemPlugin(params)
	...
	itemMixin:ContinueOnItemLoad(function()
		...
		local ICON = itemMixin:GetItemIcon()
		local ITEM_NAME = itemMixin:GetItemName()
		...
		local function CreateTooltip()
			...
			if (link) then
				...
				GameTooltip:AddLine(ITEM_NAME, 1, 1, 1)
			end
		...
		L.Elib({
			id = params.titanId,
			name = params.expName .. " Titan|cFF66b1ea " .. ITEM_NAME .. "|r",
			tooltip = ITEM_NAME,
