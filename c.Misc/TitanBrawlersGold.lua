...
local function GetButtonText(self, id)
	...
	return L["BrawlerLabel"], currencyCountText..maxBarText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["BrawlerDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mOther"].." Titan|cFF66b1ea "..L["BrawlerTitle"].."|r",
	tooltip = L["BrawlerTitle"],
	icon = ICON,
