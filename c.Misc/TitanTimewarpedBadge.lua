--[[
Description: This plugin is part of the "Titan Panel [Currencies] Multi" addon. It shows your amount of Timewarped Badge.
...
local ID = "TITAN_TMWPM"
local ICON = "Interface\\Icons\\pvecurrency-justice"
local CURRENCY_ID = 1166
...
local function GetButtonText(self, id)
	...
	return L["TimewarpedLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["TimewarpedDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mPvE"].." Titan|cFF66b1ea "..L["TimewarpedTitle"].."|r",
	tooltip = L["TimewarpedTitle"],
	icon = ICON,
