...
local ICON = "Interface\\Icons\\achievement_zone_tolbarad"
...
local function GetButtonText(self, id)
	...
	return L["TBLabel"], currencyCountText..BarBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	return L["TBDescription"].."\r\r"..ValueText
end
-----------------------------------------------
L.Elib({
	id = ID,
	name = L["mPvP"].." Titan|cFF66b1ea "..L["TBTitle"].."|r",
	tooltip = L["TBTitle"],
	icon = ICON,
