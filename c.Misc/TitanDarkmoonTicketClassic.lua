...
local function GetTooltipText(self, id)
	...
	local valorBag = L["totalbag"].. "\t" ..TitanUtils_GetHighlightText(GetItemCount(128658)).."\n"
...
L.Elib({
	id = ID,
	name = L["mEvent"].." Titan|cFF66b1ea "..L["DarkmoonClasicTitle"].."|r",
	tooltip = L["DarkmoonClasicTitle"],
	icon = ICON,
