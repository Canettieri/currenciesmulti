...
local function GetButtonText(self, id)
	...
	return L["TrickyLabel"], currencyCountText .. barBalanceText
end
-----------------------------------------------
local function GetTooltipText(self, id)
	...
	local valorBag = L["totalbag"].. "\t" ..TitanUtils_GetHighlightText(GetItemCount(33226)).."\n"
	local valorBank = L["totalbank"].. "\t" ..TitanUtils_GetHighlightText(GetItemCount(33226, true) - GetItemCount(33226))

	local ValueText = "" -- Difere com e sem moeda
	if currencyCount == 0 then
		ValueText = L["info"] .. "\n" .. "|cFFFF2e2e" .. L["HallowEnd"]
	else
	...
	return L["TrickyDescription"] .. "\r\r" .. ValueText
end
-----------------------------------------------
local eventsTable = {
...
L.Elib({
	id = ID,
	name = L["mEvent"].." Titan|cFF66b1ea " .. L["TrickyTitle"] .. "|r",
	tooltip = L["TrickyTitle"],
